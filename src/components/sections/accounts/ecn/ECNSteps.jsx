...
const steps = [
    ...
    },
    {
        ...
        title: "Deposit",
        description: "Login to your Live Account and Add Funds (Min $1,000)",
        step: "02"
    },
    {
        icon: <TrendingUp className="w-12 h-12 text-primary" />,
        title: "Trade",
        description: "Experience Direct Market Access and Raw Spreads",
        step: "03"
    }
];
        ...
        <section className="py-20 bg-gray-50">
            <Container>
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">The choice for professionals and institutional investors.</p>
                </div>

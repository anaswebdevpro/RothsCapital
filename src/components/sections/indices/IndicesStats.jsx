        ...
        <section className="py-20 bg-secondary text-white">
            <Container>
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400">Experience premium trading conditions designed for serious indices traders</p>
                </div>

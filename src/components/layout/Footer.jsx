        ...
        <footer className="bg-surface pt-16 pb-8 border-t border-gray-200">
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    {/* Contact */}
                    <div>
                        <h4 className="text-lg font-semibold text-secondary mb-6">Contact Us</h4>
                        <ul className="space-y-4">
                            <li className="flex items-start space-x-3">
                                <MapPin size={18} className="text-primary mt-1" />
                                <span className="text-gray-600 text-sm">Level 29, Marina Plaza, Dubai Metro, Dubai, UAE</span>
                            </li>
                    ...
                    {/* Newsletter */}
                    <div>
                        <h4 className="text-lg font-semibold text-secondary mb-6">Newsletter</h4>
                        <p className="text-gray-600 text-sm mb-4">Subscribe for market updates.</p>
                        <form className="flex flex-col space-y-3">
                            <input
                                type="email"
                                placeholder="Enter your email"
                                className="bg-background border border-white/10 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-primary/50 text-secondary"
                            />
                            <button className="bg-primary text-secondary font-semibold py-3 rounded-lg hover:bg-primary-hover transition-colors">
                                Subscribe
                            </button>
                        </form>
                    </div>

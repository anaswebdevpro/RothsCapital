    ...
    return (
        <section className="py-24 bg-gold-gradient relative overflow-hidden">
            ...
            <Container className="relative z-10 text-center text-secondary">
                <h2 className="text-3xl md:text-5xl font-bold mb-6">Ready to Enter the Crypto Markets?</h2>
                <p className="text-xl text-secondary/80 max-w-2xl mx-auto mb-10">
                    Join thousands of crypto traders who trust Roths Capital for secure, reliable cryptocurrency trading.
                </p>

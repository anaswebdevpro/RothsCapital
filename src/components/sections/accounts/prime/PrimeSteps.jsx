...
const steps = [
    ...
    },
    {
        ...
        title: "Deposit",
        description: "Login to your Live Account and Add Funds (Min $100)",
        step: "02"
    },
    {
        icon: <TrendingUp className="w-12 h-12 text-primary" />,
        title: "Trade",
        description: "Access the Global Financial Markets with Prime Conditions",
        step: "03"
    }
];
        ...
        <section className="py-20 bg-gray-50">
            <Container>
                <div className="text-center mb-16">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl mx-auto">Upgrade specifically designed for serious traders.</p>
                </div>
